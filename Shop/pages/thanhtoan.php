...
<form action="../timkiem.php" method="POST">
    ...
    <?php
        ...
        $sql ="INSERT INTO donhang(iduser,tongtien,trangthai,ngaymua,diachi,sdt) VALUES( $_SESSION[id], $_SESSION[total], 'Đã thanh toán','$ngaymua','$_SESSION[diachi]', $_SESSION[sdt])";
