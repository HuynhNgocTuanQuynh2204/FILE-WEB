...
<form action="../timkiem.php" method="POST">
	<div class="app">
			...
			<div class="grid wide">
				<div class="row sm-gutter grid-content">
					...
					<div class="column l-10 me-12 s-12">
						...
						<div class="home-product" align="center">
        ...
        $result = mysqli_query($conn, "SELECT * FROM sanpham ORDER BY giasp DESC LIMIT $start, $limit  ");
	...
	<div >
           <?php 
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a href="../pages/upto.php?page='.($current_page-1).'"> 
					<font size="6px">
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    ...
                    echo '<a href="../pages/upto.php?page=  '.$i.'  ">
							<font size="6px">'.$i.'</font>
						  </a> | ';
                }
            }
            ...
            if ($current_page < $total_page && $total_page > 1){
                echo '<a href="../pages/upto.php?page='.($current_page+1).'">  <font size="6px">
