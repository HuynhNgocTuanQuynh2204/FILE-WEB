...
session_start();
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			header("location: ../pages/lienhe.php");
	}
	...
	<div class="app">
		...
		<ul class="header__sort-bar">
			<li class="header__sort-item">
				<a href="" class="header__sort-link">Liên hệ</a>
			</li>
		</ul>
		...
		<div class="footer">
			<div class="grid wide">
				...
				<form action="" method="POST">
					<p>	Tin nhắn phản hồi ý kiến:	   
						<input type="text" name="noidung"  value="" placeholder="Nội dung phản hồi ý kiến" size="50px" id="noidung">
						<input type="submit" value="Gửi" id="btn">
						<script language="javascript">
							var button = document.getElementById("btn");
							button.onclick = function(){
							alert("Cảm ơn quý khách đã đống góp ý kiến với cửa hàng chúng tôi!");
										}
						</script>
					</p>
				</form>
