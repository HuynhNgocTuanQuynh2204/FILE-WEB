...
<form action="timkiem.php" method="POST">
	<div class="app">
		...
		<div class="header-mobile">
			<div class="header-mb">
				<div class="search-mb">
					<input type="text" name="s" class="search-bar-mb" placeholder="Tìm kiếm">
...
<div><marquee behavior="alternate" class="chaychu" >Chào mừng quý khách đến với cửa hàng TTShoes. Chúc quý khách một ngày tốt lành.</marquee></div><br>
		...
		<div class="navigation-bar">
			...
			<ul class="navbar-list">
				<li class="navbar-item"><a href="./pages/dangnhap.php" class="navbar-link">Đăng nhập</a></li>
						...
						<?php
							...
							<a class="home-product-item" href="./pages/sanpham.php?id= '.$row['id'].'">
								...
								<div class="home-product-item__price">
									...
									<div class="home-product-item__price-new">'.number_format($row['giasp']-($row['giasp']),3).'đ</div>
								</div>
								...
								<div class="home-product-item__sale">
									<span class="home-product-item__sale-percent"></span>
							...
							<a class="home-product-item" href="../pages/sanpham.php?id= '.$row['id'].'">>
								...
								<div class="home-product-item__price">
									<div class="home-product-item__price-old">'.number_format($row['giasp'],3).'đ</div>
									<div class="home-product-item__price-new">'.number_format($row['giasp']-($row['giasp']* ($row['giamgia']* 0.01)),3).'đ</div>
								</div>
								<div class="home-product-item__action">
									<span class="home-product-item__like home-product-item__liked">
										<i class="home-product-item__like-none far fa-heart"></i>
			...
			<div class="grid wide">
				<div class="row">
					...
					<div class="column l-2-4 me-4 s-6">
						...
						<ul class="footer-list">
							<li class="footer-item">
								<a href="../Shop/pages/gioithieu.php" class="footer-item-link">Giới thiệu</a>
							</li>
							<li class="footer-item">
