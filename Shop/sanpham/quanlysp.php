				...
				<div class="row sm-gutter grid-content">
					...
					<div class="column l-10 me-12 s-12">
						<div class="home-filter">
							<span class="label" style="margin-right: 16px;">
								<h2 style="background-color: D5E0CC;">
									<a href="themsp.php" style="color: red;">
										<img src="../img/them.jpg" alt="" width="40px" height="40px">Thêm sản phẩm
									</a>
								</h2>
							</span>					
						</div>
						...
						<?php
							...
							<a class="home-product-item" href="../pages/sanpham.php?id= '.$row['id'].'">>
								...
								<div class="home-product-item__sale">
									<span class="home-product-item__sale-percent">'.$row['giamgia'].'%</span>
							...
							<ul class="pagination">
								<li>
								<a href="../sanpham/suasp.php?id= '.$row['id'].'"><img src="../img/sua.jpg" alt="" width="40px" height="40px"></a>
								 - <a href="../sanpham/xoasp.php?id= '.$row['id'].'"style ="color: red	" ><img src="../img/thungrac.jpg" alt="" width="40px" height="40px"></a>
								</li>
							</ul>
						</div>';}
						else {
