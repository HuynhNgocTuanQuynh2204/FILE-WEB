...
if (isset($_POST['submit'])) {
  ...
  $sql= "UPDATE sanpham SET tensp='$tensp',giasp=$giasp,giamgia=$giamgia, mota='$mota',hinhanh='$hinhanh',soluong=$soluong,size=$size,mau='$mau',iddanhmuc=$iddanhmuc WHERE id=".$_GET['id'] ;
...
<html>
<head>
	<title>TT Shoes | Sửa sản phẩm</title>
	<meta charset="utf-8">
...
<form action="../timkiem.php" method="POST">
	<div class="app">
		...
		<ul class="header__sort-bar">
			<li class="header__sort-item">
				<a href="" class="header__sort-link">Sửa sản phẩm</a>
			</li>
		</ul>
					...
					<div class="column l-2 me-0 s-0">
						<nav class="category">
							<h3 class="category-heading" align="center">
								<p >***</p>
								<a href="themsp.php">Sửa sản phẩm</a>
								<p></p>
								<p  >***</p>
							</h3>
 ...
 <tr>
   <td>Giảm giá %</td>
   <td><input type="text" name="giamgia" value="<?php echo $row['giamgia'] ?>" size="100"></td>
 </tr>
