	...
	<div class="app">
		...
		<ul class="header__sort-bar">
			<li class="header__sort-item">
				<a href="" class="header__sort-link">Phản hồi ý kiến của khách hàng</a>
			</li>
		</ul>
...
<tr>
	...
	<th >Nội dung phản hồi ý kiến</th>
	<th >Thời gian</th>
	<th></th>
</tr>
</thead>
...
<?php
			...
			while ($row = mysqli_fetch_array($ketqua)) {
				...
				echo '<td><a href=" xoaphanhoi.php?id= '.$row['id'].'"><img src="../img/thungrac.jpg" alt="" width="40px" height="40px"></a></td>';
				echo "</tr>";
				$stt++;
			}
