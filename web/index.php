...
<?php
		$mysql_category = mysqli_query($con,"SELECT * FROM tbl_category ORDER BY category_id DESC ");
?>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="agileits-navi_search">
					<form action="#" method="post">
						<select id="agileinfo-nav_search" name="agileinfo_search" class="border" required="">
							...
							<?php
                                while ($row_category = mysqli_fetch_array($mysql_category)){
							?>
							<option value="<?php $row_category['category_id'] ?>"><?php echo $row_category['category_name'] ?></option>
							<?php
								}
								?>
						</select>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<?php
		                    $mysql_category_danhmuc = mysqli_query($con,"SELECT * FROM tbl_category ORDER BY category_id DESC ");
							while( $row_category_danhmuc = mysqli_fetch_array($mysql_category_danhmuc)){
                        ?>
						<li class="nav-item dropdown  mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link dropdown " href="chitietsanpham.php?id=<?php echo $row_category_danhmuc['category_id'];   ?>" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
