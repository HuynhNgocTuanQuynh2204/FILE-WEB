  ...
  function loadCategories()
  {
    ...
    $.post("./Product/apiCategories",{ID:ID}, function (data) {
      ...
      $('.category-edit').click(function(){
          ...
          "<option class='optionCategory' value="0">Giày Thượng Đỉnh</option>"
          "<option class='optionCategory' value="1">Giày Nhập Khẩu</option>"
          "<option class='optionCategory' value="2">Giày Nội Địa</option>"
          "<option class='optionCategory' value="3">Giày Thể Thao </option>"
                      "</select>`;
